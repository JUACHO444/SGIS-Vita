...
function autenticarUsuario() {
    ...
    let username_medico = $("#username_medico").val();
    let contrasena = $("#contrasena").val();

    $.ajax({
        type: "GET",
        dataType: "html",
        url: "./ServletUsuarioMedicoLogin",
        data: $.param({
            username_medico: username_medico,
        ...
        success: function (result) {
            ...
            if (parsedResult != false) {
                ...
                let username_paciente = parsedResult['username_medico'];
                document.location.href = "home.html?username_medico=" + username_medico;
            } else {
